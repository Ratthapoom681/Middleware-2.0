...
|---|---|---|---|
| `GATEWAY_PORT` | The port you use in the browser to access the system | You'll navigate to the wrong port | `80` |
...
> [!WARNING]
> Production refuses to create an administrator without an explicit bootstrap
> password. Existing users and passwords are never overwritten during startup.
