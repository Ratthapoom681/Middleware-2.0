import { cleanText, normalizeRedmineStatus } from '../../shared/lib/dashboardUtils';
import { formatRouteValue } from '../../shared/lib/dashboardUtils';
import {
  cleanBlockText,
  asArray,
  sortStrings,
...
} from '../findings/findingUtils';
import { endpointLabel, endpointHost, getEndpointParts } from '../findings/endpointUtils';
import {
  getTicketUpgradeTarget,
} from '../findings/vulnerabilityUtils';
import {
  getCompactedFindingIds,
  getCompactedFindingCount,
  chooseDisplayTitle,
  groupEndpointDetailsByCves,
} from '../findings/compactionUtils';

export const getRedmineSyncLabel = (sync) => {
  if (!sync) return '';
...
export const getRedminePriorityIdForSeverity = (severity, config) => {
...
export const formatEvidenceLine = (value = '') => {
...
export const formatSourceFindingAssets = (source = {}, endpointDetails = []) => {
...
export const getEndpointPort = (detail = {}) => {
...
export const formatAffectedAssetsAndPorts = (endpointDetails = []) => {
  const hosts = new Map();
...
export const formatTicketTextSection = (title, values) => {
  const items = values
...
export const formatDefectDojoContext = (ticket) => {
...
export const formatSourceGroupTextBlock = (title, values = [], endpointDetails = []) => {
...
export const formatSourceGroupAssets = (endpointDetails = []) => {
...
export const normalizeTextSource = (source = {}) => ({
  text: source.text || '',
...
export const collectAppendixSources = (sourceGroups = [], sourceKey = 'descriptionSources') => {
...
export const formatQuoteBlock = (value = '') => (
...
export const formatAppendixTextBlock = (title, sources = []) => {
...
export const buildSourceGroupSection = (sourceGroup = {}) => {
...
export const buildSourceGroupsBlock = (ticket) => {
...
export const buildActionRequiredMarkdown = (ticket) => {
...
export const buildSuperTicketMarkdown = (ticket) => {
...
export const normalizeBackendCveGroupForDisplay = (group) => {
